...
feature_input_details = {
    ...
    'YearBuilt': {
        ...
        'min_value': 1872,
        'max_value': 2024,
        'value': int(data['YearBuilt'].median()),
        'step': 1,
    ...
    'YearRemodAdd': {
        ...
        'min_value': 1950,
        'max_value': 2024,
        'value': int(data['YearRemodAdd'].median()),
        'step': 1,
    ...
    'GrLivArea': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['GrLivArea'].median()),
        'step': 5,
    ...
    '1stFlrSF': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['1stFlrSF'].median()),
        'step': 5,
    ...
    '2ndFlrSF': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['2ndFlrSF'].median()),
        'step': 5,
    ...
    'TotalBsmtSF': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['TotalBsmtSF'].median()),
        'step': 5,
    ...
    'LotFrontage': {
        ...
        'min_value': 0,
        'max_value': 1000,
        'value': int(data['LotFrontage'].median()),
        'step': 5,
    ...
    'BsmtFinSF1': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['BsmtFinSF1'].median()),
        'step': 5,
    ...
    'BsmtUnfSF': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['BsmtUnfSF'].median()),
        'step': 5,
    ...
    'GarageYrBlt': {
        ...
        'min_value': 1900,
        'max_value': 2024,
        'value': int(data['GarageYrBlt'].median()),
        'step': 1,
    ...
    'GarageArea': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['GarageArea'].median()),
        'step': 5,
    ...
    'WoodDeckSF': {
        ...
        'min_value': 0,
        'max_value': 10000,
        'value': int(data['WoodDeckSF'].median()),
        'step': 5,
...
with tab5:
    ...
    results_df = pd.read_csv('notebook/models/model_evaluation.csv')
    ...
    selected_model = models[best_model_name]
    X_train, X_test, y_train, y_test = joblib.load('notebook/models/train_test_data.joblib')
